...
def main():
    for folder in ['training','validation']:
        image_path = os.path.join(os.getcwd(), ('/content/drive/MyDrive/CAPSTONE/Images/' + folder))
        xml_df = xml_to_csv(image_path)
        xml_df.to_csv(('/content/drive/MyDrive/CAPSTONE/Images/' + folder + '_labels.csv'), index=None)
